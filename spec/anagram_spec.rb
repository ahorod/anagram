...
describe('String#check_all') do
  ...
  it('if a word is anagram check if it is NOT a palindrome') do
    expect('The public art galleries'.check_all('Large picture halls, I bet')).to(eq("It's just an anagram"))
  end
  it('if a word is not anagram and Not an antigram') do
  ...
  it('check if it is a antigram') do
    expect('bYe'.check_all('Hi')).to(eq("It's an antigram"))
  end
end
